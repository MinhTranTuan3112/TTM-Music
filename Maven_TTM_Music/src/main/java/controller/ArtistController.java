    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (action == null || action.trim().isEmpty()) {
                ...
                ArtistDTO artistDTO = artistDAO.load(artistid);
                ArrayList<SongDTO> song_list = SongDAO.getAllSongsOfArtist(artistid);
                ArrayList<AlbumDTO> album_list = AlbumDAO.getAllAlbumsOfArtist(artistid);
                request.setAttribute("artist", artistDTO);
